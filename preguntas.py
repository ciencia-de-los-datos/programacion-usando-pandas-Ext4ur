...
def pregunta_10():
    ...
    return df.sort_values(by=['_c1', '_c2']).groupby('_c1')['_c2'].apply(':'.join).reset_index()
...
def pregunta_12():
    ...
    df['concat'] = df['_c5a'] + ':' + df['_c5b']

    return df.sort_values(by=['_c0', '_c5a']).groupby('_c0')['concat'].apply(','.join).reset_index()
